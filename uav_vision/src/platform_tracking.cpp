...
public:
    ...
    void platformPositionCallback(const geometry_msgs::PoseStamped& platformPoistionInArdrone);
...
PlatformTracking::PlatformTracking() {
    ...
    platform_position_in_ardrone_sub_ = nh_.subscribe(platform_position_in_ardrone_topic_, 1,
                                       &PlatformTracking::platformPositionCallback, this);
...
void PlatformTracking::takeoffCallback(const std_msgs::EmptyConstPtr & takeoff_signal) {
    ...
    if (save_logs_) {
        std::string log_dir = "/home/tkp/ws/log";
        ...
        oss.str("");
        oss.clear();
        oss << "/home/tkp/ws/log/trajectories/trajectories_" << type << ".csv";
...
void PlatformTracking::platformPositionCallback(const geometry_msgs::PoseStamped& platformPoistionInArdrone) {

    centroid_in_ardrone_ = tf::Vector3(platformPoistionInArdrone.pose.position.x,
                                     platformPoistionInArdrone.pose.position.y,
                                     platformPoistionInArdrone.pose.position.z);
